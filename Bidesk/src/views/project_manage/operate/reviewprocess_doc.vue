<template>
  <div class="app-container">
    ...
    <el-row v-show="resData.hasMorePack">
      ...
      <!--默认全部-->
      <el-table :data="res_pack_list" border style="width: 100%;margin:3% 0" v-show="default_tab">
...
//    computed: {
//      bidRecordList() {
//        return this.resData.hasMorePack ? this.res_pack_list[this.handleIndex] : this.res_pack_list[0]
//      }
//    },
    methods: {
      getList() {
